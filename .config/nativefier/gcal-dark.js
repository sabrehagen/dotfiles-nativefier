...
// @description	  “<b>Really appreciate your awesome work. You are making my life so much better than Google's glaring light world.</b>” ~ pht049<br />
// @author        pyxelr
// @homepage      https://userstyles.org/styles/143026
// @run-at        document-start
// @version       0.20210502150920
// ==/UserScript==
(function() {var css = "";
if (false || (document.domain == "calendar.google.com" || document.domain.substring(document.domain.indexOf(".calendar.google.com") + 1) == "calendar.google.com"))
	css += [
...
if (false || (new RegExp("^(?=.*?\\/contacts.google.com)(?=.*?calendar.google.com).*$")).test(document.location.href))
	css += [
		"/* ==== GENERAL ==== */",
